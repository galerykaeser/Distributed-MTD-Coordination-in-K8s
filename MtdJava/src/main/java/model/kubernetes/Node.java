...
public class Node implements INode {
    ...
    /**
     * Fetch and return the node's allocatable CPU, the amount of CPU on the node that can be used by normal pods.
     *
     * @return the fetched value for the allocatable CPU.
     */
    @Override
    public double getAllocatableCpu() {
        return Objects.requireNonNull(Objects.requireNonNull(v1Node.getStatus()).getAllocatable()).get("cpu").getNumber().doubleValue();
    }
